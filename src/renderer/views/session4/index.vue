  ...
  <div class="common-layout">
    <el-container>
      <el-container>
        ...
        <el-main>
          <elecView v-show="control.chart1"></elecView>
          <userView v-show="control.chart2"></userView>
          <modelView v-show="control.chart3"></modelView>
          <session4Report v-show="control.chart4"></session4Report>
        </el-main>
      </el-container>
    </el-container>
  </div>
...
// import elecView from './components/elecView.vue'
import elecView from './components/view_o1.vue'
import session4Report from './components/view_o3.vue'
// import userView from './components/userView.vue'
import userView from './components/view_o2.vue'
import modelView from './components/view_o4.vue'
// import modelView from './components/modeView.vue'
// import session4Report from './components/session4Report.vue'
...
var func = localStorage.getItem('func4')
var x_cols = localStorage.getItem('x_cols4')
var y_col = localStorage.getItem('y_col4')
var date_col = localStorage.getItem('date_col4')
var step = localStorage.getItem('step4')
